...
public:
    ...
    dWipeMario_c(nw4r::ut::Color, mFaderBase_c::EStatus status); ///< @copydoc mFaderBase_c::mFaderBase_c
    ~dWipeMario_c(); ///< @copydoc mFaderBase_c::~mFaderBase_c
    ...
    static dWipeMario_c *m_instance; ///< The instance of the fader.
