...
namespace m3d {
    ...
    public:
        ...
        bool create(nw4r::g3d::ResMdl mdl, nw4r::g3d::ResAnmTexSrt anmTexSrt, mAllocator_c *allocator, int count) {
            return create(mdl, anmTexSrt, allocator, nullptr, count);
        }

        bool create(nw4r::g3d::ResMdl mdl, nw4r::g3d::ResAnmTexSrt anmTexSrt, mAllocator_c *allocator) {
            return create(mdl, anmTexSrt, allocator, 1);
        }
