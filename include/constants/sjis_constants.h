...
// [Translation: Actor]
#define D_ACTOR_KIND_STRING "アクター"

// [Translation: 2D display heap (m2d::create)]
#define M2D_HEAP_NAME "２Ｄ表\示用ヒープ(m2d::create)"
...
#define D2D_HEAP_NAME "２Ｄリソ\ース用ヒープ(d2d::ResAccMultLoader_c::create)"
