...
public:
    ...
    AnmObjMatClrRes* GetChild(int idx) const { return mpChildrenArray[idx]; }
...
public:
    static AnmObjMatClrOverride* Construct(MEMAllocator* pAllocator, size_t* pSize,
...
public:
    static AnmObjMatClrRes* Construct(MEMAllocator* pAllocator, size_t* pSize,
