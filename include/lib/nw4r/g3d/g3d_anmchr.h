...
public:
    ...
    AnmObjChrRes* GetChild(int idx) const { return mpChildrenArray[idx]; }
...
public:
    static AnmObjChrBlend* Construct(MEMAllocator* pAllocator, size_t* pSize,
...
public:
    static AnmObjChrRes* Construct(MEMAllocator* pAllocator, size_t* pSize,
