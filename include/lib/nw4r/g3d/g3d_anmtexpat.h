...
public:
    ...
    AnmObjTexPatRes* GetChild(int idx) const { return mpChildrenArray[idx]; }
...
public:
    static AnmObjTexPatOverride* Construct(MEMAllocator* pAllocator, size_t* pSize,
...
public:
    static AnmObjTexPatRes* Construct(MEMAllocator* pAllocator, size_t* pSize,
