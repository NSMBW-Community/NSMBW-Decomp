...
public:
    ...
    AnmObjTexSrtRes* GetChild(int idx) const { return mpChildrenArray[idx]; }
...
public:
    static AnmObjTexSrtOverride* Construct(MEMAllocator* pAllocator, size_t* pSize,
...
public:
    static AnmObjTexSrtRes* Construct(MEMAllocator* pAllocator, size_t* pSize,
