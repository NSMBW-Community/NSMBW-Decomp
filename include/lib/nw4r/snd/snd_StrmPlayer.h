...
namespace detail
{
	...
	public:
		...
		public:
			...
			ulong					mBlockSize;				// size 0x04, offset 0x20
	...
	public:
		...
		bool LoadHeader(ut::FileStream *fileStream,
		                StartOffsetType startOffsetType, int startOffset);
		bool LoadStreamData(ut::FileStream *fileStream, int offset, ulong size,
		                    ulong blockSize, int bufferBlockIndex,
		...
		bool CalcStartOffset(s32 *startBlockIndex, ulong *startBlockOffset,
		                     s32 *loopCount);
