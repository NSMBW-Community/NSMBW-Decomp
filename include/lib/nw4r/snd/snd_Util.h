...
namespace nw4r { namespace snd { namespace detail
{
	...
	public:
		...
		struct DataRef
		{
			...
			u16		reserved;
			ulong		value;		// size 0x04, offset 0x04
		}; // size 0x08
		...
		struct Table
		{
			ulong	count;		// size 0x04, offset 0x00
		...
		static void const *GetDataRefAddressImpl(RefType refType, ulong value,
...
#undef DEF_GET_DATA_REF_ADDRESS_
		...
		static inline ulong ReadBigEndian(ulong x)
		{
			return x;
		}
