...
const dBcSensor_c l_bomhei_head = { 0, 0x0, 0x10000 };
const dBcSensor_extra_c l_bomhei_foot = { { 1, -0x3000, 0x3000 }, 0 };
const dBcSensor_c l_bomhei_wall = { 0, 0x6000, 0x6000 };
const dBcSensor_c l_bomhei_4 = { 0x40000, 0, 0x10000 };
const dBcSensor_c l_bomhei_5 = { 0x40000, 0, 0 };
const dBcSensor_c l_bomhei_6 = { 0x40000, 0x6000, 0x6000 };
const dBcSensor_extra_2_c l_bomhei_7 = { {{ 0x82000001, -0x6000, 0x6000 }, 0x10000}, 0, 0 };
const dBcSensor_extra_2_c l_bomhei_8 = { {{ 0x82000001, -0x6000, 0x6000 }, 0}, 0, 0 };
const dBcSensor_extra_2_c l_bomhei_9 = { {{ 0x82000001, 0xE000, 0x3000 }, 0x8000}, 0, 0 };
...
int daEnBomhei_c::create() {
    ...
    mBc.set(this, &l_bomhei_foot.mBase, &l_bomhei_head, &l_bomhei_wall);
    mBc.m_4c = mPos.x;
...
void daEnBomhei_c::initializeState_CannonHop_Upper() {
    ...
    mBc.set(this, &l_bomhei_8.mBase.mBase, &l_bomhei_7.mBase.mBase, &l_bomhei_9.mBase.mBase);
    m_5fc = 8;
    m_23b = 1;
}
