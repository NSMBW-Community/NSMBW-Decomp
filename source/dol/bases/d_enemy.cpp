...
void dEn_c::normal_collcheck(dCc_c *self, dCc_c *other) {
    ...
    if (kind == STAGE_ACTOR_ENEMY) {
        ...
        if (actor1->mFlags & FLAG_24 || !CeilCheck(actor1->mPos.y, self)) {
            if (actor1->PlDamageCheck(self, other)) {
                actor1->mCcValue = self->unk3;
                self->mFlag |= dCc_c::CC_DISABLE;
            } else if (other->mCcData.mCategory != dCc_c::CAT_PLAYER_ATTACK) {
        ...
        s8 *plrNo = actor2->getPlrNo();
        if (*plrNo >= 0 && *plrNo < PLAYER_COUNT) {
            if (other->mCcData.mAttackCategory == dCc_c::ATTACK_YOSHI_EAT) {
...
bool dEn_c::EnDamageCheck(dCc_c *self, dCc_c *other) {
    if (other->mCcData.mAttackCategory == dCc_c::ATTACK_SHELL) {
...
bool dEn_c::PlDamageCheck(dCc_c *self, dCc_c *other) {
    ...
    if (other->mCcData.mAttackCategory == dCc_c::ATTACK_STAR && hitCallback_Star(self, other)) {
        return true;
    }
    if (other->mCcData.mAttackCategory == dCc_c::ATTACK_HIP_ATTK) {
    ...
    if (other->mCcData.mAttackCategory == dCc_c::ATTACK_SLIP) {
        if (self->mCcData.mAttackCategoryInteract & (1 << dCc_c::ATTACK_SLIP) && hitCallback_Slip(self, other)) {
            return true;
        }
    }
    if (other->mCcData.mAttackCategory == dCc_c::ATTACK_PENGUIN_SLIDE) {
    ...
    if (other->mCcData.mAttackCategory == dCc_c::ATTACK_SPIN_FALL && hitCallback_Spin(self, other)) {
        return true;
    }
    if (other->mCcData.mAttackCategory == dCc_c::ATTACK_CANNON && hitCallback_Cannon(self, other)) {
        return true;
    }
    if (other->mCcData.mAttackCategory == dCc_c::ATTACK_WIRE_NET && hitCallback_WireNet(self, other)) {
        return true;
    }
    return false;
}
...
bool dEn_c::YoshiDamageCheck(dCc_c *self, dCc_c *other) {
    ...
    if (other->mCcData.mAttackCategory == dCc_c::ATTACK_HIP_ATTK && hitCallback_YoshiHipAttk(self, other)) {
        return true;
    }
    if (other->mCcData.mAttackCategory == dCc_c::ATTACK_SLIP) {
        if (self->mCcData.mAttackCategoryInteract & (1 << dCc_c::ATTACK_SLIP) && hitCallback_Slip(self, other)) {
...
bool dEn_c::EtcDamageCheck(dCc_c *self, dCc_c *other) {
    ...
    if (other->mCcData.mAttackCategory == dCc_c::ATTACK_SHELL && owner->hitCallback_Shell(self, other)) {
        return true;
    }
    if (other->mCcData.mAttackCategory == dCc_c::ATTACK_FIRE) {
        if (self->mCcData.mAttackCategoryInteract & (1 << dCc_c::ATTACK_FIRE) && owner->hitCallback_Fire(self, other)) {
            return true;
        }
    }
    if (other->mCcData.mAttackCategory == dCc_c::ATTACK_YOSHI_FIRE) {
        if (self->mCcData.mAttackCategoryInteract & (1 << dCc_c::ATTACK_YOSHI_FIRE) && owner->hitCallback_YoshiFire(self, other)) {
            return true;
        }
    }
    if (other->mCcData.mAttackCategory == dCc_c::ATTACK_FIRE_2 && owner->hitCallback_Fire(self, other)) {
        return true;
    }
    if (other->mCcData.mAttackCategory == dCc_c::ATTACK_ICE && self->mCcData.mAttackCategoryInteract & (1 << dCc_c::ATTACK_ICE) ||
        other->mCcData.mAttackCategory == dCc_c::ATTACK_ICE_2 && self->mCcData.mAttackCategoryInteract & (1 << dCc_c::ATTACK_ICE_2)) {
        if (owner->hitCallback_Ice(self, other)) {
            return true;
        }
    }
    if (other->mCcData.mAttackCategory == dCc_c::ATTACK_YOSHI_BULLET) {
        if (self->mCcData.mAttackCategoryInteract & (1 << dCc_c::ATTACK_YOSHI_BULLET) && owner->hitCallback_YoshiBullet(self, other)) {
            return true;
        }
    }
    return false;
