...
void dWaterWave_c::wave_tex_set(mVec3_c *pos, float f, int i, u8 a) {
    ...
    mRes1 = dResMng_c::m_instance->mRes.getRes(l_bgpoly_arcdt[idx], l_bgpoly_bressdt[idx]);
    mRes2 = dResMng_c::m_instance->mRes.getRes(l_bgpoly_decarcdt[idx], l_bgpoly_decbressdt[idx]);
    mWaveQuad.create(
        m_d308,
