...
bool m3d::bmdl_c::getNodeWorldMtx(unsigned long idx, nw4r::math::MTX34 *mtx) const {
...
bool m3d::bmdl_c::getNodeWorldMtxMultVecZero(unsigned long idx, nw4r::math::VEC3 &vec) const {
    mMtx_c mtx;
...
nw4r::g3d::ResMat *m3d::bmdl_c::getResMat(unsigned long idx) const {
    nw4r::g3d::ScnMdlSimple *scnMdl = nw4r::g3d::G3dObj::DynamicCast<nw4r::g3d::ScnMdlSimple>(mpScn);
...
void m3d::bmdl_c::setTevColor(unsigned long idx, _GXTevRegID regID, _GXColor color, bool markDirty) {
    nw4r::g3d::ScnMdl *scnMdl = nw4r::g3d::G3dObj::DynamicCast<nw4r::g3d::ScnMdl>(mpScn);
    if (scnMdl != nullptr) {
...
void m3d::bmdl_c::setTevKColor(unsigned long idx, _GXTevKColorID colID, _GXColor color, bool markDirty) {
    nw4r::g3d::ScnMdl *scnMdl = nw4r::g3d::G3dObj::DynamicCast<nw4r::g3d::ScnMdl>(mpScn);
    if (scnMdl != nullptr) {
        nw4r::g3d::ScnMdl::CopiedMatAccess cma(scnMdl, idx);
        nw4r::g3d::ResMatTevColor tevColor = cma.GetResMatTevColor(markDirty);
